<template>
    ...
    <div class="w-1/2 h-full overflow-y-auto mr-10 p-4 font-mono border-black border-2">
...
<script>
import TitleComponent from './subcomponents/Title.vue'
import MediaLinks from './subcomponents/MediaLinks.vue'
export default {
    data() {
        return {
